  ...
  return (
    <main
      className={cn(
        ...
        admin
          ? "bg-[linear-gradient(180deg,#e8ecef_0%,#dfe6ea_22%,#f5f3ee_100%)]"
          : "bg-[linear-gradient(180deg,#e8eef3_0%,#f0ece3_28%,#f7f4ed_100%)]",
      )}
    >
      <div className="grid min-h-screen lg:grid-cols-[0.94fr_1.06fr]">
        <section className="relative flex min-h-[38vh] flex-col justify-between overflow-hidden border-b border-[rgba(23,32,51,0.08)] px-6 py-8 lg:min-h-screen lg:border-b-0 lg:border-r lg:px-10 lg:py-10">
          ...
          <div className="relative z-10 mt-10 max-w-xl space-y-5 border-t border-[rgba(23,32,51,0.1)] pt-6">
        ...
        <section className="flex min-h-[62vh] items-center px-4 py-8 md:px-8 lg:min-h-screen lg:px-12">
          <div className="mx-auto w-full max-w-md">
            <div className="rounded-[32px] border border-[rgba(23,32,51,0.08)] bg-[rgba(255,255,255,0.88)] p-6 shadow-[var(--shadow-soft)] backdrop-blur md:p-8">
              {props.children}
            </div>
